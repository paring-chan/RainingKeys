...
namespace RainingKeys.Utils
{
    public class RectMask2DCulling : RectMask2D
    {
        private static FieldInfo maskablesField =
            typeof(RectMask2D).GetField("m_MaskableTargets", BindingFlags.Instance | BindingFlags.NonPublic);

        private static FieldInfo ClipTargetsField =
            typeof(RectMask2D).GetField("m_ClipTargets", BindingFlags.Instance | BindingFlags.NonPublic);

        private static FieldInfo ClippersField =
            typeof(RectMask2D).GetField("m_Clippers", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        private HashSet<MaskableGraphic> maskableTargets = new();
        private HashSet<IClippable> clipTargets = new();
        private List<RectMask2D> clippers = new();
        ...
        private Rect rootCanvasRect
        {
            get
            {
                ...
                return new Rect(_corners[0].x, _corners[0].y, _corners[2].x - _corners[0].x,
